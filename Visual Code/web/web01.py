...
def check_url(url, depth=0, max_depth=10, results={'accessible': 0, 'blocked': 0}, retry_delay=20):
    ...
    try:
        ...
        if response.status_code in [301, 302, 303, 307, 308]:  # 리다이렉션 응답일 경우
...
<body>
    <header>
        <a href="/" style="position: absolute; left: 20px; top: 20px; font-size: 1rem; color: #007bff; text-decoration: none;">홈으로</a>
