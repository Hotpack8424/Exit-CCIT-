...
def check_url_with_selenium(url):
    ...
    try:
        driver.get(url)
        time.sleep(10)  # 페이지가 완전히 로드될 때까지 기다림
...
check_urls_from_excel("/Users/jungjinho/Library/Mobile Documents/com~apple~CloudDocs/대학교/중부대학교/2024/2024 3-1/모의해킹:보안컨설팅프로젝트(캡스톤디자인)/프로그램/데이터베이스_자료/분류_01/Total.xlsx")
