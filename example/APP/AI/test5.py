...
# 파일 로드 및 데이터 정제
df = pd.read_csv('/Users/jungjinho/Library/Mobile Documents/com~apple~CloudDocs/Downloads/mixing_etc6.csv')
...
# 모델 저장
joblib.dump(best_xgb_model, '/Users/jungjinho/Desktop/xgb_model_05.pkl')
